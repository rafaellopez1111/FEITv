...
public class JFrame_consultaruser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        consult_button.addActionListener(this::consult_buttonActionPerformed);
    ...
    private void consult_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        if (controller != null) controller.consultarUsuario();
    }

    private void go_back_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        if (controller != null) controller.voltarConsulta();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JFrame_consultaruser frame = new JFrame_consultaruser();
